...
def run() -> None:
    ...
    # (x, y, z, t) for SAX and (x, y, t) for LAX
    ...
    batch = {
        ...
        "lax_2c": lax_2c_image[None, ..., t].to(dtype=torch.float32),
        "lax_3c": lax_3c_image[None, ..., t].to(dtype=torch.float32),
        "lax_4c": lax_4c_image[None, ..., t].to(dtype=torch.float32),
    }
