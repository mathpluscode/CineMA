...
def get_lax_2c_4c_plane_intersection(
    ...
    Args:
        lax_2c_image: 2c image, GetSize() = (x, y, 1, t).
        lax_4c_image: 4c image, GetSize() = (x, y, 1, t).
...
def get_sax_center(
    ...
    sax_origin = sax_image.GetOrigin()[:3]
    sax_rot = np.array(sax_image.GetDirection()).reshape((4, 4))[:3, :3]
...
def get_origin_for_crop(
    ...
    rot = np.array(image.GetDirection()).reshape((4, 4))[:3, :3]
