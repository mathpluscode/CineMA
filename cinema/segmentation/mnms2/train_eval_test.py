...
from cinema.segmentation.mnms2.train import load_dataset
...
def test_seg_train_eval(mocker: MockFixture, model: str, views: str | list[str]) -> None:
    """Test training.
    ...
    if model == "unet":
        if len(views) > 1:
            return  # skip multi-view for UNet
