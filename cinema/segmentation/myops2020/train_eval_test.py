...
from cinema.segmentation.myops2020.eval import segmentation_eval_myops2020_dataset
from cinema.segmentation.myops2020.train import (
    load_dataset,
    myops2020_segmentation_eval_dataloader,
)
...
def test_seg_train_eval(mocker: MockFixture, model: str) -> None:
    ...
    config.data.dir = cache_dir / "myops2020" / "processed"
